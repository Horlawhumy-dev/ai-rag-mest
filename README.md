# HCode AI - AI Assistant

HCode AI is an AI Assistant created by Arafat Olayiwola from Lagos, Nigeria. It can summarize articles from URLs and PDFs, and engage in conversation.

## Features

- **Chat**: Have a conversation with H
- **URL Summarization**: Paste a link to an article and get a summary
- **PDF Summarization**: Upload a PDF document and get a summary
- **Personality**: H has a unique personality based on its creator
...
- H will respond based on its personality

### Summarize a URL
1. Go to the "URL Summary" tab
2. Paste the article URL
3. Click "Summarize URL"
4. H will fetch and summarize the article

### Summarize a PDF
1. Go to the "PDF Summary" tab
2. Upload a PDF file
3. Click "Summarize PDF"
4. H will extract text and summarize the PDF
...
│   ├── personality.py  # H's personality
...
Logs are stored in the `logs/` directory. Check `logs/H_assistant.log` for application logs.
